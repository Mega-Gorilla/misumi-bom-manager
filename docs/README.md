...
- [`plans/0018-excel-link-mode/`](./plans/0018-excel-link-mode/) — Excel リンクモード：Excel を BOM の正本とし、アプリは読み取りと EC 列の書き戻しに徹する（[Issue #18](https://github.com/Mega-Gorilla/misumi-bom-manager/issues/18)）
